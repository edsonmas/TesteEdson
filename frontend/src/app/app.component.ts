    ...
    ngOnInit() {
        ...
        this.menuService.itens = [
            ...
            { label: 'Usuarios', icon: 'person', items:[
                { label: 'Cadastrar', icon: 'list', routerLink: ['/usuarios/cadastrar'] },
                { label: 'Listar', icon: 'list', routerLink: ['/usuarios/listar'] },
                { label: 'Buscar por Nome', icon: 'list', routerLink: ['/usuarios/buscar'] },
                { label: 'Inativar Usuario', icon: 'ban', routerLink: ['/usuarios/inativar'] }
            ] },
            { label: 'Eventos', icon: 'event', items:[
                { label: 'Cadastrar', icon: 'list', routerLink: ['/eventos/cadastrar'] },
                { label: 'Listar', icon: 'list', routerLink: ['/eventos/listar'] },
                { label: 'Proximos patrocinadores', icon: 'list', routerLink: ['/eventos/buscar'] },
                { label: 'Inativar Usuario', icon: 'ban', routerLink: ['/eventos/inativar'] }
            ] },
        ];
    }
